...
var knife,fruit ,monster,fruitGroup,monsterGroup, score,r,randomFruit, position,knifeSwoosh,gameOverSound;
...
function Monster(){
  if(World.frameCount%200===0){
    ...
    console.log("monster",monster.velocityX);
...
function fruits(){
  if(World.frameCount%80===0){
    ...
    console.log("fruits",fruits.velocityX);
